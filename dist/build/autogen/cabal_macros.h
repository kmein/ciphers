...
/* package ciphers-0.1.0.0 */
#define VERSION_ciphers "0.1.0.0"
#define MIN_VERSION_ciphers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "ciphers-0.1.0.0-IB38R3DFBzL8vN5Js7sPzX"

#define CURRENT_PACKAGE_KEY "IB38R3DFBzL8vN5Js7sPzX"
